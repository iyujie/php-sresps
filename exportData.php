...
mysqli_query($con, "SELECT * FROM phpsres
INTO OUTFILE 'datatest.csv'
FIELDS ESCAPED BY '""'
TERMINATED BY ','
ENCLOSED BY ''
LINES TERMINATED BY '\r\n'  ");
...
$result = mysqli_query($con, 'SELECT * FROM phpsres');
...
$db_name = "phpsres"; // db name
$tbl_name = "Sales"; // table name of the selected db
